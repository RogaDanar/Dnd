...
namespace Dnd.Core.Model.Actions.Attacks
{
    ...
    public abstract class AbstractAttackAction : IAction<AttackResult>
    {
        ...
        protected IWeapon _weapon { get { return Attacker.Equipment.GetEquipedWeapon(); } }
        protected bool _surprise { get; set; }

        public ICharacter Attacker { get; protected set; }
        public ICharacter Defender { get; protected set; }
        ...
        protected virtual bool IsHit(int attackRoll) {
            return attackRoll >= Defender.AC(_surprise);
        }
